@extends('layouts.app')
@section('title', 'Giới thiệu - BeatyCare 🌸')
@section('content')
<div class="container py-5">
    <div class="text-center mb-5">
        <span class="text-primary fw-bold small text-uppercase">Về BeatyCare 🌸</span>
        <h1 class="fw-bold mt-2">Chăm sóc vẻ đẹp theo cách dịu dàng hơn</h1>
        <p class="text-muted mx-auto" style="max-width: 680px">BeatyCare 🌸 mang đến những sản phẩm làm đẹp được chọn lọc để bạn tự tin chăm sóc bản thân mỗi ngày.</p>
    </div>
    <div class="row g-4">
        ...
        <div class="col-md-4"><div class="card h-100 border-0 shadow-sm p-4"><i class="bi bi-chat-heart text-primary fs-2 mb-3"></i><h4>Luôn lắng nghe</h4><p class="text-muted mb-0">Đội ngũ BeatyCare sẵn sàng tư vấn và đồng hành cùng bạn sau mỗi đơn hàng.</p></div></div>
    </div>
</div>
@endsection
