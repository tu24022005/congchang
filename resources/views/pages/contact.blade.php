@extends('layouts.app')
@section('title', 'Liên hệ - BeatyCare 🌸')
@section('content')
<div class="container py-5">
    <div class="text-center mb-5"><span class="text-primary fw-bold small text-uppercase">Liên hệ</span><h1 class="fw-bold mt-2">BeatyCare 🌸 luôn sẵn sàng hỗ trợ</h1><p class="text-muted">Hãy liên hệ với chúng mình khi bạn cần tư vấn về sản phẩm hoặc đơn hàng.</p></div>
