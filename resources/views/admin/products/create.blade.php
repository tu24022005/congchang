...
<div class="mb-3">
    ...
    <input type="file" name="gallery[]" class="form-control" multiple>
            ...
            <div class="mb-3">
                ...
                <input type="number" step="0.01" name="price" id="price" class="form-control @error('price') is-invalid @enderror" value="{{ old('price') }}" required min="0">
                @error('price')
                    <div class="invalid-feedback">{{ $message }}</div>
                @enderror
            </div>
            ...
            <div class="border rounded-3 p-3 mb-4">
                <div class="d-flex justify-content-between align-items-center mb-3">
                    <div><h5 class="fw-bold mb-1">Mã và phân loại sản phẩm</h5><small class="text-muted">Thêm SKU, màu, khối lượng/dung tích (g, kg, ml, l) và tồn kho riêng.</small></div>
                ...
                <div id="variations-list">
                    @foreach($variationRows as $index => $variation)
                        <div class="row g-2 align-items-end variation-row mb-2">
                            ...
                            <div class="col-md-1"><label class="form-label small">Giá</label><input type="number" min="0" name="variations[{{ $index }}][price]" class="form-control" value="{{ $variation['price'] ?? old('price') }}"></div>
