@extends('layouts.app')
@section('title', 'Câu hỏi thường gặp - Aloha Beauty')
@section('content')
<div class="container py-5">
    ...
    <div class="accordion mx-auto" id="faqAccordion" style="max-width: 850px">
        @foreach([
            ['Bạn có thể thanh toán bằng hình thức nào?', 'Aloha Beauty hỗ trợ thanh toán khi nhận hàng (COD) và thanh toán online qua PayOS.'],
